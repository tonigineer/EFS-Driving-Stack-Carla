# Parameter file for Ackermann Control of ROS-Bridge (default K* result in really poor behavior)
...
echo "${YELLOW}~/ros2_ws/${RESET} was build again, due to newly linked config"